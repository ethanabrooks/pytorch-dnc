...
EnvDict = {"copy": CopyEnv, "repeat-copy": RepeatCopyEnv}
...
CircuitDict = {
    ...
    "dnc": DNCCircuit,
}  # lstm_controller + dynamic_accessor

from core.agents.empty_agent import EmptyAgent
from core.agents.sl_agent import SLAgent

AgentDict = {
    "empty": EmptyAgent,  # to test integration of new envs, contains only the most basic control loop
    "sl": SLAgent,
